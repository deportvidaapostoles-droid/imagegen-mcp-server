...
export function createTools(provider, defaultTimeout) {
    ...
    const imageDesc = "An image to edit. Can be an absolute file path (e.g., /path/to/image.png) or a base64-encoded image string (optionally as a data URL like data:image/png;base64,...). " +
    ...
    const imagesProp = {
        images: {
            type: "array",
            description: "One or more images to edit. Each item can be an absolute file path or a base64-encoded image string." +
                imagesNote,
            items: {
                type: "string",
