 ...
 */
export async function handleMcpRequest(req, res, config, options = {}) {
    ...
    if (req.method === "GET" || req.method === "DELETE") {
        ...
        writeJson(res, 405, jsonRpcError(-32000, "Method not allowed. This MCP endpoint is stateless: use POST."));
        return;
    }
    if (req.method !== "POST") {
        res.setHeader("Allow", "POST, OPTIONS");
