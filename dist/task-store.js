...
import { extractImages } from "./image-service.js";
...
export class TaskStore {
    ...
    startCleanupTimer(intervalMs = 600_000) {
     ...
     */
    async waitFor(id, timeoutMs, pollIntervalMs = 500) {
    ...
    async process(task) {
        ...
        for (let attempt = 1; attempt <= maxRetries; attempt += 1) {
            try {
                const content = task.kind === "generate"
