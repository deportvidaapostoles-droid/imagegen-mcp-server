...
async function testDirectOpenAI() {
    ...
    if (!image.b64_json)
        throw new Error('Expected b64_json response');
    console.log(`Direct ${OPENAI_IMAGE_MODEL}: received b64_json`);
}
async function testMcpOverStdio() {
    ...
    const client = new Client({ name: 'openai-proxy-smoke-test', version: '1.0.0' }, { capabilities: {} });
    try {
...
//# sourceMappingURL=test-openai-proxy.js.map